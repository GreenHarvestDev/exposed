...
- Any conduct that would reasonably be considered inappropriate in a professional
  setting.

## Enforcement

Instances of abusive or otherwise unacceptable behavior may be reported to the
project maintainers via GitHub. Maintainers are responsible for clarifying standards
and may remove, edit, or reject contributions that violate this Code of Conduct.
